...
//   const sendMessageCallback = (chatInput) =>
//     sendMessage(chatInput, socket, currentRoomId, username, displayMessage, chatMessages, myPeerId)
...
//       // Automatically create room when a type is selected
//       if (token) {
...
//         // Show the watch room and movie upload section
...
//       alert(
//         `Failed to create room: ${error.message || "Unknown error"}. Please check your network or contact support if the issue persists.`,
//       )
//       roomModal.classList.add("active")
//     }
//   })
